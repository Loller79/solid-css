...
const data = {
  int: {
    ...
    'brt': '{ border-radius: calc(var(--intensity) * $INT) calc(var(--intensity) * $INT) 0 0 }',
    'brb': '{ border-radius: 0 0 calc(var(--intensity) * $INT) calc(var(--intensity) * $INT) }',
    'brl': '{ border-radius: calc(var(--intensity) * $INT) 0 0 calc(var(--intensity) * $INT) }',
    'brr': '{ border-radius: 0 calc(var(--intensity) * $INT) calc(var(--intensity) * $INT) 0 }',
